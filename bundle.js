...
var Main = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(AddUser, { addNew: this.state.addUser }),
...
var AddUser = React.createClass({
  ...
  changeRole1: function changeRole1(e) {
    this.setState({ role1: event.target.value });
  },
  changeRole2: function changeRole2(e) {
    this.setState({ role2: event.target.value });
  },
  changeRole3: function changeRole3(e) {
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        'form',
        null,
        'Add User//Add button and drop down for fields User Name:',
        React.createElement('input', { type: 'text', value: 'Name', onChange: this.changeName }),
        'User Roles:',
        React.createElement('input', { type: 'text', value: this.state.role1, onChange: this.changeRole1 }),
        React.createElement('input', { type: 'text', value: this.state.role2, onChange: this.changeRole2 }),
        React.createElement('input', { type: 'text', value: this.state.role3, onChange: this.changeRole3 }),
        React.createElement('input', { type: 'submit', value: 'Submit', onClick: this.submitUser })
      )
    );
  }
});
